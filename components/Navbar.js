          ...
          <div className="relative flex items-center justify-between h-16">
            ...
            <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
              <div className="flex-shrink-0 flex items-center">
                <h4 className="font-mono text-xl text-gray-800 font-bold hidden lg:block">
                  TALA{" "}
                  <img
                    src="logo.png"
                    alt="Logo"
                  ...
                  ></img>
                  <h1 className="font-mono text-sm text-gray-600">
                    fundraising company
                  </h1>
                </h4>
              </div>
              <div className="hidden sm:block sm:ml-6">
                <div className="flex space-x-4">
                  <Link href="/dashboard">
                    <span
                      className={`${
                        router.pathname === "/dashboard" ? "bg-[#F7C984]" : ""
                  ...
                  <Link href="/Projects">
                    <span
                      className={`${
                        router.pathname === "/Projects" ? "bg-[#F7C984]" : ""
                      } text-greay px-3 py-2 rounded-md text-sm font-medium hover:cursor-pointer hover:bg-[#F7C984] hover:text-greay`}
                    >
                      Projects
                    </span>
